...
public class ConsultaViagemPropriasLogica implements Logica{
	...
	public void executa(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
		...
		RequestDispatcher rd = httpServletRequest.getRequestDispatcher("privado/consulta/viagemPropriasConsultaF.jsp");
