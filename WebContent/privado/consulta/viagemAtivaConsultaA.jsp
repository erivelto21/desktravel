...
<body>
	...
	<fieldset>
		<legend>Viagens aprovada: </legend>
...
<%-- 						<td><button class="sum" type="button" data-toggle="modal" data-target="#myModal1${viagem.id}">Trabalhos</button></td> --%>
