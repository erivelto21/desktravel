...
<%-- 													<td>${viagem.motivo}</td> --%>
							        ...
							        <div class="modal-footer">
							           <form action="sistema">
							          	<input type="hidden" name="logica" value="DecidirViagem"/>
							          	<input type="hidden" name="idViagem" value="${viagem.id}"/>
							          	<input id="decis${viagem.id}" type="hidden" name="decisao"/>
							          	<input class="btn btn-default butaoDecisao" type="submit" onclick="butaoAprova(${viagem.id})" value="Aprovar"/>
							          	<input class="btn btn-default butaoDecisao" type="submit" onclick="butaoNega(${viagem.id})" value="Negar"/>
							          	<button id="ca" type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
							          </form>							   
							        </div>
							      </div>
